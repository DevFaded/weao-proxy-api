...
- Fetch current Roblox versions: `http://localhost:6767/api/versions/current`
- Fetch future Roblox versions: `http://localhost:6767/api/versions/future`
- Fetch all exploit statuses: `http://localhost:6767/api/status/exploits`
- Fetch a specific exploit status: `http://localhost:6767/api/status/exploits/[exploit]` (Replace `[exploit]` with the name of the executor. Example: `solara`)

These endpoints will accept your requests to the [Whatexpsare.online](https://weao.xyz/) API with the correct User-Agent headers and return the response.
